...
export function DashboardPage() {
  ...
  return (
    <section className="space-y-6">
      <div>
        <p className="text-sm font-semibold uppercase tracking-wide text-emerald-300">{t('dashboard.eyebrow')}</p>
        <h1 className="mt-2 text-4xl font-bold text-white">{t('dashboard.title', { name: user?.name })}</h1>
