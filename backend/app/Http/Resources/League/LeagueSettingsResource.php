...
class LeagueSettingsResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            LeagueSetting::DEFENSE_MODIFIER_THRESHOLDS => $this->defenseModifierThresholds(),
            ...
            LeagueSetting::GOAL_BONUS => $this->goalBonus(),
            LeagueSetting::ASSIST_BONUS => $this->assistBonus(),
            LeagueSetting::YELLOW_CARD_MALUS => $this->yellowCardMalus(),
            LeagueSetting::RED_CARD_MALUS => $this->redCardMalus(),
            LeagueSetting::OWN_GOAL_MALUS => $this->ownGoalMalus(),
            LeagueSetting::PENALTY_SCORED_BONUS => $this->penaltyScoredBonus(),
            LeagueSetting::PENALTY_MISSED_MALUS => $this->penaltyMissedMalus(),
            LeagueSetting::PENALTY_SAVED_BONUS => $this->penaltySavedBonus(),
            LeagueSetting::GOAL_CONCEDED_MALUS => $this->goalConcededMalus(),
            LeagueSetting::FIRST_GOAL_THRESHOLD => $this->when(
                $this->isHeadToHead(),
                fn(): float => $this->firstGoalThreshold(),
            ),
            LeagueSetting::GOAL_INTERVAL => $this->when(
                $this->isHeadToHead(),
                fn(): float => $this->goalInterval(),
            ),
