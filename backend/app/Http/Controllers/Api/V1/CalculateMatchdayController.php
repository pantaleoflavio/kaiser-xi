...
{
    public function __invoke(League $league, Matchday $matchday, FinalizeMatchday $finalizer): MatchdayResource|JsonResponse
    {
        ...
        try {
            $finalizer->calculate($league, $matchday);
        ...
        return new MatchdayResource($matchday);
    }
}
