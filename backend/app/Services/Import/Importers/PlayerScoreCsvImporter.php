...
class PlayerScoreCsvImporter implements CsvImporter
{
    ...
    public function contract(): array
    {
        ...
        return [
            ...
            'required_create' => ['competition_code', 'season_name', 'matchday_number', 'status', 'a complete preferred or fallback registration identity', 'final_score when status is confirmed'],
            ...
            'behavior' => 'Player scores are global real-football data, not League-specific. Empty optional cells preserve values on update; creates use PlayerScore defaults. did_not_play clears ratings and score, resets every event to zero, and sets both booleans to false. final_score is supplied authoritative fantasy scoring input and is never calculated by this import.',
